...
<!--<div class="slideshow-container" style="width:1200px;">
  <div class="mySlides fade">
    ...
    <div class="w3-animate-zoom text" style="font-size: 70px; color: white; font-weight: bold; font-family: arial; padding-bottom: 100px; padding-left: 200px; text-align: center;">Beautiful Mysore Palace</div>
  </div>
...
<br><br>
Few of the places you can visit in Mysore.
<br><br>
